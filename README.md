# ESG & Social Data Exploration and Analysis in R
...
### 1. Environmental Monitoring: Air Pollution ('air_pollution_four_cities_master.R')
...
### 2. Social & Developmental Indicators: Child Problem Solving ('child_problem_solving_master.R')
...
### 3. Social Policy Attitude Survey: Smoking Ban ('smokingsurvey_master.R')
...
### 4. Corporate Governance & Employee Sentiment ('survey.R')
